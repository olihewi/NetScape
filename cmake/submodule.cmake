...
if (GIT_FOUND AND EXISTS "${PROJECT_SOURCE_DIR}/.git")
  ...
  if (GIT_SUBMODULE)
    ...
    if( NOT WIN32 )
      execute_process(
              COMMAND chmod u+x -R ${PROJECT_SOURCE_DIR}/extern/cmake-scripts/githooks
              WORKING_DIRECTORY "${PROJECT_SOURCE_DIR}"
              OUTPUT_QUIET
              OUTPUT_STRIP_TRAILING_WHITESPACE)
    endif()

    #file(CHMOD_RECURSE ${PROJECT_SOURCE_DIR}/extern/cmake-scripts/githooks PERMISSIONS OWNER_EXECUTE)
    find_program(
